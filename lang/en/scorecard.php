...
$string['completiondetail:submit'] = 'Submit a scorecard attempt';
$string['completionsubmit'] = 'Submit a scorecard attempt';
...
$string['privacy:export:attempts'] = 'Attempts';
...
$string['privacy:metadata:scorecard_responses:itemid'] = 'Reference to the item this response answered. Together with attemptid, identifies which prompt the response value corresponds to — without itemid, an exported response value is meaningless because the user cannot tell which prompt it answered (per SPEC §9.5).';
...
$string['report:col:attemptnumber'] = 'Attempt';
$string['report:col:band'] = 'Band';
$string['report:col:fullname'] = 'Name';
$string['report:col:maxscore'] = 'Max';
$string['report:col:noband'] = 'No band match';
$string['report:col:percentage'] = 'Percentage';
$string['report:col:submitted'] = 'Submitted';
$string['report:col:totalscore'] = 'Score';
$string['report:col:userid'] = 'User ID';
$string['report:col:username'] = 'Username';
$string['report:detail:deletedprefix'] = '[deleted] ';
$string['report:detail:heading'] = 'Detail';
$string['report:detail:outofrange'] = ' (out of range: expected {$a->min}–{$a->max})';
...
$string['report:export:button'] = 'Export CSV';
$string['report:export:noattempts'] = 'No attempts to export.';
$string['report:export:nocapability'] = 'You do not have permission to export attempts for this scorecard.';
...
$string['template:export:button'] = 'Export template';
$string['template:export:tooltip'] = 'Download the items, bands, and settings as a JSON template that can be imported into another course.';
$string['template:filename:fallback'] = 'scorecard-template.json';
$string['template:import:empty:button'] = 'Import template';
$string['template:import:empty:tooltip'] = 'Populate this empty scorecard with items and bands from a JSON template file.';
$string['template:import:error:bandcreatefailed'] = 'Band creation failed during import.';
$string['template:import:error:cmcreatefailed'] = 'Course module creation failed during import.';
$string['template:import:error:coursenotfound'] = 'Destination course was not found.';
$string['template:import:error:dbwrite'] = 'Database write failed during import.';
$string['template:import:error:itemcreatefailed'] = 'Item creation failed during import.';
$string['template:import:error:notempty'] = 'This scorecard already has items or bands. Import is only available for empty scorecards.';
$string['template:import:errors:heading'] = 'Template validation errors';
$string['template:import:errors:intro'] = 'Fix these issues in the source template before importing. The template will not be imported until these errors are resolved.';
$string['template:import:fileread:error'] = 'Could not read the uploaded file.';
$string['template:import:fileupload'] = 'Template JSON file';
$string['template:import:fileupload_help'] = 'Upload a scorecard template JSON file. Templates are exported from the Manage page of an existing scorecard.';
$string['template:import:heading'] = 'Import scorecard template';
$string['template:import:jsondecode:error'] = 'The uploaded file is not valid JSON.';
$string['template:import:notify:redirected'] = 'Template imported. {$a->itemcount} items and {$a->bandcount} bands added.';
$string['template:import:notify:success'] = 'Scorecard imported successfully.';
$string['template:import:notify:successwithwarnings'] = 'Scorecard imported with {$a} warnings.';
...
$string['template:validate:band:missingfield'] = 'Band is missing a required field.';
$string['template:validate:band:rangeinvalid'] = 'Band minscore must be less than or equal to maxscore.';
$string['template:validate:band:wrongtype'] = 'Band field has the wrong type.';
$string['template:validate:envelope:missingfield'] = 'Required envelope field is missing.';
$string['template:validate:envelope:wrongtype'] = 'Envelope field has the wrong type.';
$string['template:validate:exportedat:invalid'] = 'Exported timestamp is not a valid ISO 8601 UTC value.';
$string['template:validate:item:flagvalue'] = 'Item flag must be 0 or 1.';
$string['template:validate:item:missingfield'] = 'Item is missing a required field.';
$string['template:validate:item:wrongtype'] = 'Item field has the wrong type.';
$string['template:validate:plugin:versionmismatch'] = 'Template was exported from a different plugin version. Import may proceed but verify the result.';
$string['template:validate:plugin:wrongname'] = 'Template was exported from a different plugin; only mod_scorecard templates can be imported here.';
$string['template:validate:schemaversion:unsupported'] = 'Schema version is not supported by this plugin version.';
$string['template:validate:scorecard:displaystylelocked'] = 'Display style must be \'radio\' at this version.';
$string['template:validate:scorecard:missingfield'] = 'Scorecard settings are missing a required field.';
$string['template:validate:scorecard:rangeinvalid'] = 'Scale minimum must be less than scale maximum.';
$string['template:validate:scorecard:wrongtype'] = 'Scorecard setting has the wrong type.';
$string['template:validate:unknownfield'] = 'Field is not recognized at this schema version; data will be ignored on import.';
